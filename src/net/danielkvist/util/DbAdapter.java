...
public class DbAdapter
{
    ...
    private static final String DATABASE_INIT_SETTING_STORAGE = "INSERT INTO " + DATABASE_TABLE_SETTINGS + " (" + KEY_NAME + ","
            + KEY_SETTING_VALUE + ") " + "values " + "('" + Setting.SETTING_STORAGE + "',0" + ");";

    private static final String DATABASE_INIT_SETTING_SOUND = "INSERT INTO " + DATABASE_TABLE_SETTINGS + " (" + KEY_NAME + ","
            + KEY_SETTING_VALUE + ") " + "values " + "('" + Setting.SETTING_SOUND + "',0" + ");";
    ...
    {
        return db.query(DATABASE_TABLE_SETTINGS, new String[] { KEY_ROWID, KEY_NAME, KEY_SETTING_VALUE }, null, null, null, null, null);
    }
    ...
    public Cursor fetchReceipt(long rowId)
    {
        ...
        return db.query(true, DATABASE_TABLE_RECEIPTS, new String[] { KEY_ROWID, KEY_NAME, KEY_PHOTO, KEY_TIMESTAMP, KEY_LOCATION_LAT,
    ...
    {
        return db.query(true, DATABASE_TABLE_RECEIPTS, new String[] { KEY_ROWID, KEY_NAME, KEY_PHOTO, KEY_TIMESTAMP, KEY_LOCATION_LAT,
                KEY_LOCATION_LONG, KEY_SUM, KEY_TAX, KEY_COMMENT, KEY_ACCOUNT_ID }, KEY_TIMESTAMP + ">" + timeFrom + " AND "
    ...
    {
        return db.rawQuery(
                "SELECT SUM(" + KEY_SUM + ") FROM " + DATABASE_TABLE_RECEIPTS + " WHERE " + KEY_ACCOUNT_ID + "=" + codeWhereArgs, null);
    }
    ...
    {
        return db.query(true, DATABASE_TABLE_RECEIPTS, new String[] { KEY_ROWID, KEY_NAME, KEY_PHOTO, KEY_TIMESTAMP, KEY_LOCATION_LAT,
                KEY_LOCATION_LONG, KEY_SUM, KEY_TAX, KEY_COMMENT, KEY_ACCOUNT_ID }, null, null, null, null, KEY_ROWID + " DESC", "1");
    }
    ...
    public Cursor fetchSetting(String name)
    {
        ...
        return db.query(true, DATABASE_TABLE_SETTINGS, new String[] { KEY_ROWID, KEY_NAME, KEY_SETTING_VALUE }, KEY_NAME + "='" + name
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        {
            String[] queries = { DATABASE_CREATE_TABLE_RECEIPTS, DATABASE_CREATE_TABLE_SETTINGS, DATABASE_INIT_SETTING_SUM,
                    DATABASE_INIT_SETTING_TAX, DATABASE_INIT_SETTING_COMMENT, DATABASE_INIT_SETTING_LOCATION,
                    DATABASE_INIT_SETTING_ACCOUNT, DATABASE_INIT_SETTING_DEFAULT_ACCOUNTS, DATABASE_INIT_SETTING_STORAGE,
