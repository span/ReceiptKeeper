...
public class AccountTable {
	...
	public static final String[] COLUMNS = { KEY_ROWID, KEY_NAME, KEY_CODE,
			KEY_CATEGORY };
	...
	private static void initDatabaseData(SQLiteDatabase db, Context context) {
		...
		try {
			...
			Log.e(AccountTable.class.getName(),
					"read database init file error at db import");
		} finally {
			db.endTransaction();
			if (br != null) {
				try {
					...
					Log.e(AccountTable.class.getName(),
							"buffer reader close error at db import");
				}
			}
		}
	}
