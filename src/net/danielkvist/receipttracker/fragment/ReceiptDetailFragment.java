...
/**
 * This Fragment shows any details related to the selected Receipt. It also
 * hooks into the options menu to add an Edit icon and a Delete icon. It also
 * uses some custom Callbacks to talk with it's parent Activity.
 * 
 * @author Daniel Kvist
 * 
 */
public class ReceiptDetailFragment extends Fragment {
	...
	public void onAttach(Activity activity) {
		...
		this.receipt = (Receipt) getArguments().getParcelable(
	...
	/**
	 * Makes sure we retain the Fragment instance when needed and set flag to
	 * add options on the OptionsMenu.
	 */
	@Override
	...
	/**
	 * Builds an intent that takes the path for the image and passes it to the
	 * sharing mechanism as a stream built on the URI of the image path.
	 * 
	...
	/**
	 * Set up the View contents that is needed to display the information about
	 * the Receipt.
	 */
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		imageView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setDataAndType(
						Uri.parse("file://" + receipt.getPhoto()), "image/*");
		...
		commentView = (TextView) rootView
				.findViewById(R.id.detail_receipt_comment);
