...
public class ReceiptSettingsFragment extends Fragment
{
    ...
    /**
     * Handles a selection of the options menu and triggers the delete/save/add actions and updates the TabHost
     * as appropriate.
     */
    ...
    /**
     * Saves a new receipt account based on the fields in the TabHost values. It does a validation of the data and
