...
/**
 * This class can be used to get an instance of a DialogFragment which shows the standard DatePickerDialog. It uses an
 * OnClickListener to bypass a bug in the Android API that has problems with the standard OnDateSetListener.
 * 
...
public class DatePickerFragment extends DialogFragment
{
    ...
    /**
     * Set the callback for the caller. Note that this cannot be used until Bug 2 has been fixed.
     * 
     * @param callBack
     */
    ...
    /**
     * Set a listener class that will handle the result from the DataPickerDialog. This is used as a workaround until
