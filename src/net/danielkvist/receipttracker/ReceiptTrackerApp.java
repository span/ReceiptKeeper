...
/**
 * This is the main Application wrapper for the app. This class handles some
 * Singleton instances that need to be globally available such as the
 * BitmapLoader and it's cache.
 * 
 * @author Daniel Kvist
 * 
 */
public class ReceiptTrackerApp extends Application {
	...
	public void onTrimMemory(int level) {
		...
		// TODO When http://code.google.com/p/android/issues/detail?id=35349 is
		// fixed, add check for TRIM_MEMORY_BACKGROUND and
