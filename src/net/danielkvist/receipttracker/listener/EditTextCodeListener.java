...
public class EditTextCodeListener implements View.OnKeyListener {
	...
	/**
	 * Constructor which takes a communicator as a parameter which is needed to
	...
	/**
	 * An onKeyListener that keeps track of the number of chars we have in the
	 * field. It allows for erasing with keycode 67.
	 */
	@Override
	public boolean onKey(View v, int keyCode, KeyEvent event) {
		EditText e = (EditText) v;

		// Check length and keys to show warning when numeric key pressed and
		// allow "other" keys like back etc.
