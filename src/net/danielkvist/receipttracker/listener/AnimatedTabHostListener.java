...
public class AnimatedTabHostListener implements OnTabChangeListener
{
    ...
    /**
     * A gesture listener that listens for a left or right swipe and uses the swip gesture to navigate a TabHost that uses
     * an AnimatedTabHost listener.
     * @author Daniel Kvist
     *
     */
    class MyGestureDetector extends SimpleOnGestureListener
    {
        ...
        /**
         * Listens for the onFling event and performs some calculations between the touch down point and the
         * touch up point. It then uses that information to calculate if the swipe was long enough. It also
         * uses the swiping velocity to decide if it was a "true" swipe or just some random touching.
         */
        @Override
