...
public class Receipt implements Parcelable {
	...
	/**
	 * Constructor for the class that initiates all strings to empty strings,
	 * sets the timestamp to the current time in ms and any integer values gets
	 * set to -1.
	 */
	public Receipt() {
		id = -1;
	 ...
	 */
	public Receipt(int id, String name, String photo, long timestamp,
			String locationLat, String locationLong, String sum, String tax,
	...
	/**
	 * This method returns the receipts date as a String that is formatted
	...
	/**
	 * This method returns the receipts time as a String that is formatted
	 * according to the users preferences.
	 * 
	 * @param context
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeStringArray(new String[] { name, photo, locationLat,
				locationLong, sum, tax, comment });
	}
